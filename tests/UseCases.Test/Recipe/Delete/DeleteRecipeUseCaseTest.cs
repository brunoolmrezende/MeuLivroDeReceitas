...
namespace UseCases.Test.Recipe.Delete
{
    public class DeleteRecipeUseCaseTest
    {
        ...
        public async Task Error_Recipe_Not_Found()
        {
            ...
            Func<Task> act = async () => { await useCase.Execute(recipeId: 1); };
            ...
            MyRecipeBook.Domain.Entities.Recipe? recipe = null)
        {
            ...
            return new DeleteRecipeUseCase(loggedUser, recipeWriteOnlyRepository, recipeReadOnlyRepository, unitOfWork, blobStorage);
        }
    }
}
